<?php
include_once("../banco.php"); // Inclua o arquivo de conexão ao banco de dados

// Consulta para obter grupos de operadores
$sql = 'SELECT id, nome FROM gruposoperadores';
              ...
              <form action="processa-operador.php" method="post">
                <div class="tab-content" id="myTabContent">
                  <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                    ...
                    <div class="mb-3">
                      <label for="exampleFormControlInput1" class="form-label">Grupo de operadores</label>
                      <select name="gruposoperadores" class="form-select" required>
                        <?php
            ...
            <table class="table">
              ...
              <tbody>
                ...
                while($row_usuario = mysqli_fetch_assoc($resultado_usuarios)){
                    ...
                    echo "<td>
                            <a href='perfilOperador.php?id=" . $row_usuario['id'] . "' class='btn btn-warning'>Detalhes</a>
                          </td>";
                    echo "</tr>";
                }
                ?>
