...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="cabecalho container">
      <div class="esquerda">
        <h1>Gerenciar grupos de clientes</h1>
      </div>

      <div class="direita">
          <button type="button" class="btn btn-success botao" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bi bi-plus"></i>  Adicionar grupo de clientes</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Adicionar grupo de clientes</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form action="processa-grupoCliente.php" method="post">
      ...
      <div class="modal-footer">
        <input type="submit" class="btn btn-success" value="Adicionar grupo de clientes">
      </div>
    </form>
    </div>
  </div>
        ...
        <div class="card-body">
          ...
          <table class="table">
            ...
            <tbody>
              ...
              <?php
    $result_usuarios = "SELECT * FROM gruposclientes";
